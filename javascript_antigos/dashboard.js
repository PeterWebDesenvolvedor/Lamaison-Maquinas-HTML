...
async function loadDashboardStats() {
  ...
  try {
    ...
    grid.innerHTML = `
            <div class="stat-card">
                <div class="stat-icon" style="color: #a97421;">
            ...
            <div class="stat-card">
                <div class="stat-icon" style="color: #C29C6B;">
            ...
            <div class="stat-card">
                <div class="stat-icon" style="color: #604A35;">
                    <span data-icon="DollarSign"></span>
                </div>
                <div class="stat-info">
                    <h3>Faturamento</h3>
            ...
            <div class="stat-card">
                <div class="stat-icon" style="color: #302F32;">
